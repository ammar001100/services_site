...
<section class="tp-banner-container">
            <div class="tp-banner">
                <ul>
                    ...
                    <img src="{{asset('images/sliders')}}/{{$slider->image}}" alt="{{$slider->name}}" data-bgposition="center center"
            ...
            <div class="filter-title">
                <div class="title-header">
                    <h1 style="color:#fff;">خبير للخدمات المنزلية</h1>
                    <p class="lead">جميع الخدمات المنزلية في مكان واحد</p>
                </div>
                <div class="filter-header">
                    <form id="sform" action="{{ route('search_service') }}" method="post"> 
                        @csrf                       
                        <input type="text" id="q" name="q" required="required" placeholder="ابحث عن خدمة"
                        ...
                        <div class="col-md-12">
                            <ul id="sponsors" class="tooltip-hover">
                                ...
                                <li data-toggle="tooltip" title="" data-original-title="{{ $category->name }}"> 
                                    <a href="{{ route('home.service_by_category',$category->slug) }}">
