                              ...
                              <div class="thinborder-ontop text-center">
                                  ...
                                  <form id="userregisterationform" enctype="multipart/form-data" wire:submit.prevent="create">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <select id="service_category_id" class="form-control" name="service_category_id" wire:model="service_category_id">
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="form-group row">
                                          <label for="thumbnail" class="col-md-4 col-form-label text-md-right">الصورة المصغرة</label>
                                          <div class="col-md-6">
                                              <input id="thumbnail" type="file" class="form-control" name="thumbnail" autofocus wire:model="thumbnail">
                                              @error('thumbnail')
                                              <p class="text-danger">{{$message}}</p>
                                              @enderror
                                              @if($thumbnail)
