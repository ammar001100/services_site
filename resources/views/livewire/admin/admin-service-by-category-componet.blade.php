                ...
                <div class="container">
                    ...
                    <div class="crumbs">
                        <ul>
                            ...
                            <li>/</li>
                            <li>مدير النظام / {{ $category_name }} خدمات</li>
                        </ul>
                    </div>
                </div>
            </div>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody style="center">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                            <a href="{{route('admin.services',['id'=>$service->id])}}"><i class="fa  fa-edit fa-2x"></i></a>
                                            <a href="#" onclick="confirm('هل انت متاكد من عملية الحذف') || event.stopImmediatePropagation()" wire:click.prevent = 'deleteService({{$service->id}})'><i style="margin-right:10px" class="fa  fa-times fa-2x text-danger"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
