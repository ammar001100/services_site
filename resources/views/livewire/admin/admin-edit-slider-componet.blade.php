                      ...
                      <div class="container">
                          <div class="col-xs-12 col-sm-6 col-md-6 col-md-offset-3 profile1" style="padding-bottom:40px;">
                              <div class="thinborder-ontop text-center">
                                  <h3>ادخل بيانات الشريط المنزلق للتعديل</h3>
                                  ...
                                  <form id="userregisterationform" enctype="multipart/form-data" wire:submit.prevent="update">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <select id="status" class="form-control" name="status" wire:model="status">
                                                ...
                                                <option value="0" @if($status == 0) selected @endif>غير مفعل</option> 
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            @else
                                              <img src="{{ asset('images/sliders') }}/{{ $image }}" width="60" />
                                            @endif
                                        </div>
                                    </div>
